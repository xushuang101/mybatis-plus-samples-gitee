    ...
    public void dSelect() {
        mapper.insert(
                new User().setId(10086L)
                        ...
                        .setAge(3));
        mapper.insert(
                new User().setId(10001L)
                        .setName("dianxin")
                        .setEmail("dianxin@baomidou.com")
                        .setAge(3));
        assertThat(mapper.selectById(10086L).getEmail()).isEqualTo("miemie@baomidou.com");
        //User user = mapper.selectOne(new QueryWrapper<User>().lambda().eq(User::getAge, 3));
        List<User> userList = mapper.selectList(new QueryWrapper<User>().lambda().eq(User::getId, 10086));
